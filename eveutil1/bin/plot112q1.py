...
def main():
    days = 7
    fullhistory(days, '/home/forcer/public_html/em-kills-112Q1.png')
    fullhistory(days, '/home/forcer/public_html/em-kills-1st-112Q1.png',
                aboutshift=1)
    fullhistory(days, '/home/forcer/public_html/em-kills-2nd-112Q1.png',
                aboutshift=2)
    fullhistory(days, '/home/forcer/public_html/em-kills-3rd-112Q1.png',
                aboutshift=3)
...
def fullhistory(days, outfile, aboutshift=None):
    ...
    longwar("2010-01-01", "2010-01-17", "Militia", 2)
    longwar("2010-02-06", "2010-02-28", "Providence", 2)
    longwar("2010-03-07", "2010-03-14", "TOWM war")
    longwar("2010-03-16", "2010-03-23", "DELAI war")
    ...
    mvgstart = datetime.datetime.strptime("2010-01-01", "%Y-%m-%d")
